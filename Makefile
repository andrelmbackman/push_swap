...
src/push_swap/alphasort.c src/push_swap/get_destined.c \
src/push_swap/pushback_subchunks.c src/push_swap/pushback_subchunks2.c \
src/push_swap/pushback_helpers.c
